...
def home(request):
    # all()
    #data = Student.objects.create(stu_name='siya',
    #stu_city='rewa',
    #stu_email='siya15pa@gmail.com')
    #data1=Student.objects.first()
    #print(data1)
    #return HttpResponse(data1)
    data=Student.objects.filter(id=1).update(stu_name='sanchita',stu_city='rewa')
    #data=data.values()
    print(data)
